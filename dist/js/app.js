(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".creators-module__slider")) new swiper_core_Swiper(".creators-module__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".creators-module__arrow_left",
                    nextEl: ".creators-module__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1
            ...
            if (document.querySelector(".quick-bytes__slider")) new swiper_core_Swiper(".quick-bytes__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".quick-bytes__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".quick-bytes__arrow_left",
                    nextEl: ".quick-bytes__arrow_right"
                },
                on: {}
            });
        }
        ...
        if (userHeader) document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".user-header__arrow")) userHeader.classList.toggle("user-header_open"); else if (!targetElement.closest(".user-header")) userHeader.classList.remove("user-header_open");
        }));
        const search = document.querySelector(".search");
        if (search) document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".search__icon")) search.classList.add("search__open"); else if (!targetElement.closest(".search")) search.classList.remove("search__open");
        }));
        ...
        function newsBuild(data) {
            ...
            if (news.length) {
                ...
                news.forEach((newsItem => {
                    ...
                    for (const key in newsItem) templateItem = templateItem.replace(`%${key}%`, newsItem[key]);
                    if (!newsItem.image) {
